...
func TestShapes(t *testing.T) {
	...
	test.T(t, RegularPolygon(3, 2.0, false), MustParseSVG("M0 -2L1.7321 1L-1.7321 1z"))
	...
	test.T(t, StarPolygon(3, 4.0, 2.0, false), MustParseSVG("M0 -4L1.7321 -1L3.4641 2L0 2L-3.4641 2L-1.7321 -1z"))
}
