...
func TestPathStroke(t *testing.T) {
	var tts = []struct {
		...
		{"M10 10V5H15L10 10z", 2.0, ButtCapper, RoundJoiner, "M11 10V5L10 6H15L14.293 4.2929L9.2929 9.2929L11 10H9A1 1 0 0 0 10.707 10.707L15.707 5.7071A1 1 0 0 0 15 4H10A1 1 0 0 0 9 5V10z"},
		{"M10 10V5H15z", 2.0, ButtCapper, RoundJoiner, "M11 10V5L10 6H15L14.293 4.2929L9.2929 9.2929L11 10H9A1 1 0 0 0 10.707 10.707L15.707 5.7071A1 1 0 0 0 15 4H10A1 1 0 0 0 9 5V10z"},
