...
func TestPathSettle(t *testing.T) {
	var tts = []struct {
		...
		{NonZero, "M-1.0012776039598066 0.9987223960401934L0.5679470168256557 0.9987223960401934L0.5679320848125826 0.9991455162279408L0.5689697381460519 1.0137330234576891z M0.56848134703489 0.9835813767807052L0.5679320848125826 0.9991455162279408L0.5680837466356934 1.0012776039598066L-1.0012776039598066 1.0012776039598066z", "M-1.0012776 0.9987224L-0.774616 0.9987224L0.56848135 0.9835813800000001L0.56794701 0.9987224L0.56794702 0.9987224L0.5679320800000001 0.99914552L0.56808375 1.0012776L0.56896974 1.01373302L-0.7339801 1.0012776L-1.0012776 1.0012776L-0.8786234 0.9998949z"},
	}
	for _, tt := range tts {
		t.Run(fmt.Sprint(tt.p), func(t *testing.T) {
			p := MustParseSVGPath(tt.p)
