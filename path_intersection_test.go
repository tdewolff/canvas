...
func TestBentleyOttmannPrecision(t *testing.T) {
	var tts = []struct {
		...
		{"L4 1L2 2L1 1L4 0z", "L4 0L2 1zM1 1L4 1L2 2z"},

		// intersection is moved downwards
		{"L4 1L2 2L-1 1L4 0z", "M-1 1L2 0L4 1L2 2z"},

		// one intersection and one passing snap to (2,2)
		{"M-2 -1L5 3L-3 1L-2 0L5 4L6 4L6 -1z", "M-3 1L-2 0L2 2zM-2 -1L6 -1L6 4L5 4L2 2z"},

		// two intersections snap to (2,2)
		{"M-2 -1L4 3L5 3L-3 1L-2 4L4 1z", "M-3 1L2 2L-2 4zM-2 -1L4 1L2 2z"},
		{"M-2 -1L7 5L9 4L-3 1L-2 4L4 1z", "M-3 1L2 2L-2 4zM-2 -1L4 1L2 2zM3 3L9 4L7 5z"},

		// one intersections in (2,1) and one in (2,2), first intersection causes second
		{"M0 1L4 1L4 2L0 2L0 3L3 3L1 0z", "M0 1L1 0L2 1zM0 2L2 2L3 3L0 3zM2 1L4 1L4 2L2 2z"},

		// one intersections in (2,1) and one in (2,2), first intersection passes through (2,2)
		{"M0 1L4 1L4 -1L-1 -1L7 5L11 6L-15 -4zM-4 1L4 3L4 4L-4 4z", "M-15 -4L0 1L2 1L2 2zM-4 1L2 2L4 3L4 4L-4 4zM-1 -1L4 -1L4 1L2 1zM4 3L11 6L7 5z"},

		// segments becomes vertical and overlapping
		{"M1 4L2.1 1L2 3L2 0L3 0L3 4z", "M1 4L2 3L2 0L3 0L3 4z"},
		{"M1 4L2.4 1L2 3L2 0L3 0L3 4z", "M1 4L2 3L2 0L3 0L3 4z"},
		{"M2.6 4L2.4 1L2 3L2 0L3 0L3 4z", "M2 0L3 0L3 4L2 1z"},

		// collapse only bottom-left corner
		{"M0 2L2 2L1 3L1 1z", "M1 2L2 2L1 3z"},
		{"M0 2L2 2L1 1L1 3z", "M0 2L1 2L1 3zM1 1L2 2L1 2z"},

		// segment is almost vertical but downward-sloped
		{"M0 2L2 2L1 3L1.0000000000000002 0z", "M0 2L1 0L1 2zM1 2L2 2L1 3z"},
		//{"M0 2L2 2L1 3L1.0000000000000002 -20z", "M0 2L1 -20L1 2zM1 2L2 2L1 3z"},
	}
	...
	for _, tt := range tts {
		t.Run(fmt.Sprint(tt.p), func(t *testing.T) {
			p := MustParseSVGPath(tt.p)
			r := bentleyOttmann(p.Split(), nil, opSettle, NonZero)
