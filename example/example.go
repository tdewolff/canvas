...
func Draw(c *canvas.Canvas) {
	...
	rich.Add(face, "1")
	rich.Add(dejaVuSerif.Face(12.0, canvas.Black, canvas.FontRegular, canvas.FontSubscript), "1")
	rich.Add(dejaVuSerif.Face(12.0, canvas.Black, canvas.FontRegular, canvas.FontSuperscript), "2")
	rich.Add(face, " dolor\". confiscatur. ")
