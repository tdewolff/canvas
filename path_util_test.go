...
func TestCubicBezierStroke(t *testing.T) {
	...
	test.T(t, strokeCubicBezier(Point{0, 0}, Point{80, 100}, Point{80, -100}, Point{100, 0}, 0.1, 50), MustParseSVG("M0.078087 -0.062570L11.922 13.186L100.1 -0.019612"))
}
