...
func TestPathToSVG(t *testing.T) {
	var tts = []struct {
		...
		{"", ""},
		{"L10 0Q15 10 20 0M20 10C20 20 30 20 30 10z", "H10Q15 10 20 0M20 10C20 20 30 20 30 10z"},
		{"L10 0M20 0L30 0", "H10M20 0H30"},
		{"L0 0L0 10L20 20", "20 20"},
		{"A5 5 0 0 1 10 0", "A5 5 0 0110 0"},
		{"A10 5 90 0 0 10 0", "A5 10 0 0010 0"},
		{"A10 5 90 1 0 10 0", "A5 10 0 1010 0"},
		{"M20 0L20 0", ""},
	}
	for _, tt := range tts {
		t.Run(tt.p, func(t *testing.T) {
